...
class GenerateEverythingDialog(QDialog):
...
class CompleteGenerationProgressDialog(QDialog):
    def __init__(self, parent, seed, name, width, height, num_plates):
        QDialog.__init__(self, parent)
        self._init_ui()
        self.world = None
        self.gen_thread = CompleteGenerationThread(self, seed, name, width, height, num_plates)
...
class CompleteGenerationThread(threading.Thread):
    def __init__(self, ui, seed, name, width, height, num_plates):
        threading.Thread.__init__(self)
        self.plates_generation = CompleteGeneration(seed, name, width, height, num_plates=num_plates)
        self.ui = ui
...
class CompleteGeneration(object):
